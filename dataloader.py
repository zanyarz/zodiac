...
class Dataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        if opt.train_f1 == 1:
            tmp = self.split_ix['train']
            self.split_ix['train'] = tmp[5000:50000]
            self.split_ix['test'] = tmp[0:5000]
            del tmp

        elif opt.train_f2 == 1:
            tmp = self.split_ix['train']
            self.split_ix['train'] = tmp[0:5000] + tmp[10000:50000]
            #self.split_ix['train'].append(tmp[10000:50000])
            self.split_ix['test'] = tmp[5000:10000]
            del tmp
        
        elif opt.train_f3 == 1:
            tmp = self.split_ix['train']
            self.split_ix['train'] = tmp[0:10000] + tmp[15000:50000]
            #self.split_ix['train'].append(tmp[15000:50000])
            self.split_ix['test'] = tmp[10000:15000]
            del tmp

        elif opt.train_f4 == 1:
            tmp = self.split_ix['train']
            self.split_ix['train'] = tmp[0:15000]+tmp[20000:50000]
            #self.split_ix['train'].append(tmp[20000:50000])
            self.split_ix['test'] = tmp[15000:20000]
            del tmp
        
        elif opt.train_f5 == 1:
            tmp = self.split_ix['train']
            self.split_ix['train'] = tmp[0:20000]+tmp[25000:50000]
            #self.split_ix['train'].append(tmp[25000:50000])
            self.split_ix['test'] = tmp[20000:25000]
            del tmp
        
        elif opt.train_f6 == 1:
            tmp = self.split_ix['train']
            self.split_ix['train'] = tmp[0:25000]+tmp[30000:50000]
            #self.split_ix['train'].append(tmp[30000:50000])
            self.split_ix['test'] = tmp[25000:30000]
            del tmp
        
        elif opt.train_f7 == 1:
            tmp = self.split_ix['train']
            self.split_ix['train'] = tmp[0:30000]+tmp[35000:50000]
            #self.split_ix['train'].append(tmp[35000:50000])
            self.split_ix['test'] = tmp[30000:35000]
            del tmp
        
        elif opt.train_f8 == 1:
            tmp = self.split_ix['train']
            self.split_ix['train'] = tmp[0:35000]+tmp[40000:50000]
            #self.split_ix['train'].append(tmp[40000:50000])
            self.split_ix['test'] = tmp[35000:40000]
            del tmp
        
        elif opt.train_f9 == 1:
            tmp = self.split_ix['train']
            self.split_ix['train'] = tmp[0:40000]+tmp[45000:50000]
            #self.split_ix['train'].append(tmp[45000:50000])
            self.split_ix['test'] = tmp[40000:45000]
            del tmp
        
        elif opt.train_f10 == 1:
            tmp = self.split_ix['train']
            self.split_ix['train'] = tmp[0:45000]
            self.split_ix['test'] = tmp[45000:50000]
            del tmp
