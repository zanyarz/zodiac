...
def parse_opt():
    ...
    parser.add_argument('--train_f1', type=int, default=0, help='fold1 karpathy split')
    parser.add_argument('--train_f2', type=int, default=0, help='fold1 karpathy split')
    parser.add_argument('--train_f3', type=int, default=0, help='fold1 karpathy split')
    parser.add_argument('--train_f4', type=int, default=0, help='fold1 karpathy split')
    parser.add_argument('--train_f5', type=int, default=0, help='fold1 karpathy split')
    parser.add_argument('--train_f6', type=int, default=0, help='fold1 karpathy split')
    parser.add_argument('--train_f7', type=int, default=0, help='fold1 karpathy split')
    parser.add_argument('--train_f8', type=int, default=0, help='fold1 karpathy split')
    parser.add_argument('--train_f9', type=int, default=0, help='fold1 karpathy split')
    parser.add_argument('--train_f10', type=int, default=0, help='fold1 karpathy split')
    ...
    parser.add_argument('--d_ff', type=int, default=2048,
                    help='')
    parser.add_argument('--num_att_heads', type=int, default=12,
                    help='')
    ...
    parser.add_argument('--train_sample_n', type=int, default=16,
                    help='The reward weight from cider')
    parser.add_argument('--train_sample_method', type=str, default='beam_search',
                    help='')
    parser.add_argument('--train_beam_size', type=int, default=5,
                    help='')

    # Used for self critical
    parser.add_argument('--sc_sample_method', type=str, default='beam_search',
                    help='')
    parser.add_argument('--sc_beam_size', type=int, default=5,
                    help='')
...
if __name__ == '__main__':
    ...
    print()
    sys.argv = [sys.argv[0], '--cfg', args.cfg, '--caption_model', args.caption_model]
    args2 = parse_opt()
